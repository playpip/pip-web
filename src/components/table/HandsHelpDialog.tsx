...
const HANDS: { name: string; made: string; cards: string[] }[] = [
  { name: 'Royal Flush', made: 'A-K-Q-J-10, all the same suit.', cards: ['Ah', 'Kh', 'Qh', 'Jh', 'Th'] },
  { name: 'Straight Flush', made: 'Five in sequence, all one suit.', cards: ['9s', '8s', '7s', '6s', '5s'] },
  { name: 'Four of a Kind', made: 'Four cards of the same rank.', cards: ['Qc', 'Qd', 'Qh', 'Qs', '4h'] },
  { name: 'Full House', made: 'Three of a kind plus a pair.', cards: ['Jh', 'Jd', 'Js', '8c', '8h'] },
  { name: 'Flush', made: 'Five of the same suit, any order.', cards: ['Kd', 'Td', '8d', '5d', '2d'] },
  { name: 'Straight', made: 'Five in sequence, mixed suits.', cards: ['9c', '8d', '7h', '6s', '5c'] },
  { name: 'Three of a Kind', made: 'Three cards of the same rank.', cards: ['7h', '7d', '7s', 'Kc', '2d'] },
  ...
  { name: 'High Card', made: 'None of the above — highest card plays.', cards: ['Ah', 'Qd', '9s', '6c', '2d'] },
]
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="-mx-1 flex max-h-[65vh] flex-col gap-2 overflow-y-auto px-1 pt-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {HANDS.map((hand, i) => (
            <div key={hand.name} className="flex items-center gap-3 rounded-xl bg-foreground/[0.03] p-2.5">
